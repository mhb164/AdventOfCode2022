...
public class Day12Benchmark
{
    ...
    {
        var firstTryPerformer = new SolutionPerformer<Day12Puzzle, Day12FirstTrySolution>(null);
        First = firstTryPerformer.Solution;
        ActualInput = firstTryPerformer.ActualInput;
        Second = new SolutionPerformer<Day12Puzzle, Day12SecondTrySolution>(null).Solution;
    }
