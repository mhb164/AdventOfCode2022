...
public class Day06Benchmark
{
    ...
    {
        var firstTryPerformer = new SolutionPerformer<Day06Puzzle, Day06FirstTrySolution>(null);
        First = firstTryPerformer.Solution;
        ActualInput = firstTryPerformer.ActualInput;
        Second = new SolutionPerformer<Day06Puzzle, Day06SecondTrySolution>(null).Solution;
        Third = new SolutionPerformer<Day06Puzzle, Day06ThirdTrySolution>(null).Solution;
    }
