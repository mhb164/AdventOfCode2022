...
public class Day10Benchmark
{
    ...
    {
        var firstTryPerformer = new SolutionPerformer<Day10Puzzle, Day10FirstTrySolution>(null);
        First = firstTryPerformer.Solution;
        ActualInput = firstTryPerformer.ActualInput;
        Second = new SolutionPerformer<Day10Puzzle, Day10SecondTrySolution>(null).Solution;
    }
