...
public class Day03Benchmark
{
    ...
    {
        var firstTryPerformer = new SolutionPerformer<Day03Puzzle, Day03FirstTrySolution>(null);
        First = firstTryPerformer.Solution;
        ActualInput = firstTryPerformer.ActualInput;
        Second = new SolutionPerformer<Day03Puzzle, Day03SecondTrySolution>(null).Solution;
    }
