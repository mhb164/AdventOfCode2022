...
public class Day07Benchmark
{
    ...
    {
        var firstTryPerformer = new SolutionPerformer<Day07Puzzle, Day07FirstTrySolution>(null);
        First = firstTryPerformer.Solution;
        ActualInput = firstTryPerformer.ActualInput;
        Second = new SolutionPerformer<Day07Puzzle, Day07SecondTrySolution>(null).Solution;
    }
