...
public class Day08Benchmark
{
    ...
    {
        var firstTryPerformer = new SolutionPerformer<Day08Puzzle, Day08FirstTrySolution>(null);
        First = firstTryPerformer.Solution;
        ActualInput = firstTryPerformer.ActualInput;
        Second = new SolutionPerformer<Day08Puzzle, Day08SecondTrySolution>(null).Solution;
    }
